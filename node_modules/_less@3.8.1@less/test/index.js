...
var testMap = [
    ...
    [{rootpath: 'http://example.com/account/css/', rewriteUrls: 'all'}, 'rootpath-rewrite-urls-all/'],
    [{rootpath: 'http://example.com/account/css/', rewriteUrls: 'local'}, 'rootpath-rewrite-urls-local/'],
